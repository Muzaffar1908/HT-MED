        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('admin.category.index')}}" class="nav-link
              @if(Str::substr(Request::getRequestUri(), 0,15) == '/admin/category')
               active
              @endif
            ">
               <i class="nav-icon bi bi-sliders"></i>
          ...
          <li class="nav-item">
            <a href="{{route('admin.subcategory.index')}}" class="nav-link
              @if(Str::substr(Request::getRequestUri(), 0,18) == '/admin/subcategory')
               active
              @endif
            ">
               <i class="nav-icon bi bi-sliders"></i>
          ...
          <li class="nav-item">
            <a href="{{route('admin.product.index')}}" class="nav-link
              @if(Str::substr(Request::getRequestUri(), 0,14) == '/admin/product')
               active
              @endif
            ">
          ...
          <li class="nav-item">
            <a href="{{route('admin.servise.index')}}" class="nav-link
              @if(Str::substr(Request::getRequestUri(), 0,14) == '/admin/servise')
               active
              @endif
            ">
          ...
          <li class="nav-item">
            <a href="{{route('admin.connection.index')}}" class="nav-link
              @if(Str::substr(Request::getRequestUri(), 0,17) == '/admin/connection')
               active
              @endif
            ">
          ...
          <li class="nav-item">
            <a href="{{route('admin.footer.index')}}" class="nav-link
              @if(Str::substr(Request::getRequestUri(), 0,13) == '/admin/footer')
               active
              @endif
            ">
